...
(() => {
 ...
 const PRESENT = {
  1: [
    ...
    { en: "I don’t have brothers.", es: "No tengo hermanos." },
  ...
  2: [
    ...
    { en: "I don’t make the bed.", es: "No hago la cama." },
  ...
  3: [
    ...
    { en: "I don’t drink coffee in the morning.", es: "No bebo café por la mañana." },
  ...
  4: [
    ...
    { en: "I don’t use it much.", es: "No lo uso mucho." },
  ...
  5: [
    ...
    { en: "I don’t forget my homework.", es: "No olvido los deberes." },
  ...
  6: [
    ...
    { en: "I don’t drink fizzy drinks.", es: "No bebo refrescos." },
  ...
  7: [
    ...
    { en: "I don’t use my phone while studying.", es: "No uso el móvil mientras estudio." },
  ...
  8: [
    ...
    { en: "I don’t cook very well.", es: "No cocino muy bien." },
    ...
    { en: "I don’t break house rules.", es: "No rompo las reglas de la casa." },
  ...
  9: [
    ...
    { en: "I don’t use screens after ten.", es: "No uso pantallas después de las diez." },
  ...
  10: [
    ...
    { en: "I don’t sleep badly.", es: "No duermo mal." },
    ...
    { en: "I’m happy with my routine.", es: "Estoy contento con mi rutina." },
    ...
    { en: "I don’t forget my responsibilities.", es: "No olvido mis responsabilidades." },
